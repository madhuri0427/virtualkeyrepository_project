...
public class WelcomeScreen {
	...
	public static void main(String[] args) {
		...
		File directory = new File("C://Users//madhuri//Desktop//Simplilearn//FileCreation//");
		...
		System.out.println("*****************************************");
		System.out.println("******* Madhuri Wankhade  *********************");
		...
		do {
			...
			case 1:
				...
				try {
					File file = new File("C://Users//madhuri//Desktop//Simplilearn//FileCreation//" + filename + ".txt");
			...
			case 3:
				...
				File directory_delete = new File("C://Users//madhuri//Desktop//Simplilearn//FileCreation//");
				...
				if (flist_delete == null) {
					...
					for (int i = 0; i < flist_delete.length; i++) {
						...
						if (delete_filename.equalsIgnoreCase(filename)) {
							...
							File file = new File(
									"C://Users//madhuri//Desktop//Simplilearn//FileCreation//" + delete_filename);
							if (file.delete()) {
			...
			case 4:
				...
				File directory_search = new File("C://Users//madhuri//Desktop//Simplilearn//FileCreation//");
	...
	private static void listOfFiles() {
		...
		File folder = new File("C://Users//madhuri//Desktop//Simplilearn//FileCreation//");
